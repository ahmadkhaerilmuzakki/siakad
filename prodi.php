...
<html lang="en">
  ...
  <body>
    <div class="container">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link" href="khs.php">
                  <i class="fa-solid fa-file"></i> KHS
                </a>
              </li>
      ...
      <br />
      <div class="card">
        <div class="card-header text-center" style="background-color: #a4bfccde">
          Matakuliah UTM Mataram
        </div>
        <div class="table-responsive px-3">
          <table id="prodiTable" class="table table-bordered table-striped text-center">
            ...
            <tbody>
              ...
              ?>
                <tr>
                  ...
                  <td>
                    <a href="prodiEdit.php?kode_prodi=<?= $data['kode_prodi']; ?>" class="btn btn-warning btn-sm">Edit</a>
                    <a href="prodiHapus.php?kode_prodi=<?= $data['kode_prodi']; ?>" class="btn btn-danger btn-sm"
                      onclick="return confirm('Apakah Anda yakin menghapus data prodi ini?')">Delete</a>
                  </td>
                </tr>
              <?php } ?>
            </tbody>
          ...
          <!-- Tombol Tambah Prodi di bawah kanan -->
          <div class="add-container">
            <a href="addprodi.php" class="add-button">+ Tambah Prodi</a>
          </div>
        </div>
      </div>
    </div>
